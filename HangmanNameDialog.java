...
public class HangmanNameDialog extends JDialog
{
	...
	HangmanNameDialog(HangmanFrame owner, String title, boolean modal)
	{
		...
		welcomeLabel = new JLabel("Welcome to the Hangman Game");
...
quitButton.setBackground(Color.BLUE);
		...
		addWindowListener(new WindowAdapter(){
			...
			public void windowClosed(WindowEvent we){
				((HangmanFrame)frame).setName(nameField.getName());
			}
		});
	}
