...
public class RPS
{
	...
	private RPSNameDialog nameDialog;
	private RPSConnectDialog connectDialog;
	...
	RPS() throws IOException 
	{
		frame = new RPSFrame();

		server = new RPSServer(this, frame);
		...
		nameDialog = new RPSNameDialog(frame, "Hangman", true);

		connectDialog = new RPSConnectDialog(frame, "Hangman", true);
	...
	private void connect(){
		...
		if(gameSocket!=null){
			...
			RPSProtocol proto = new RPSProtocol(gameSocket, frame, false);
		}
	}
